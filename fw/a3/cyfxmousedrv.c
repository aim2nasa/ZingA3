...
CyFxMouseDriverInit ()
{
    ...
    if (status != CY_U3P_SUCCESS)
    {
    	CyU3PDebugPrint (4, "CyU3PUsbHostEpSetXfer app_error=%d\r\n",status);
        goto app_error;
    }
    ...
    if (status != CY_U3P_SUCCESS)
    {
    	CyU3PDebugPrint (4, "CyU3PDmaChannelSetXfer app_error=%d\r\n",status);
        goto app_error;
    }
